...
const WhyChooseUs = () => {
  ...
  return (
    <motion.section
      ...
      className="flex flex-col items-start justify-between gap-10 bg-white px-4 py-12 lg:flex-row lg:gap-52 lg:px-36 lg:py-24"
    >
      <motion.div
      ...
      <div className="flex flex-col gap-14">
        <motion.div variants={itemVariants} className="px-4 text-lg">
          <p>
            ...
            collection of modern furniture is crafted with precision, using the
            highest quality materials. Each piece is designed to blend
            seamlessly with your space, adding a touch of sophistication without
            overwhelming your environment. With Ember, you don&apos;t just
