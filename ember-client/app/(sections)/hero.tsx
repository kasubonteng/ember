    ...
    <section className="flex h-screen w-full items-center justify-center overflow-hidden">
      ...
      >
        <motion.div
          ...
          className="mt-[120px] flex flex-col items-center gap-4 px-4 text-center lg:mt-[160px] lg:px-0"
        >
          <motion.div
          ...
          <motion.h1
            ...
            className="mt-[10px] max-w-[861px] text-6xl font-bold text-black lg:text-7xl"
          >
          ...
          <motion.p
            ...
            className="mt-[40px] max-w-[606px] text-2xl text-black lg:mt-[55px]"
          >
